...
<div class="<?php if (isset($data->class)) {
	...
	<select <?php if (isset($data->multi) && $data->multi == '1') {
				echo 'multiple class="selectpicker"';
			} else {
				echo 'class="selectpicker"';
			} ?> data-size="10" name="<?php echo esc_attr($data->name); ?>" id="<?php echo esc_attr($data->name) . '-' . uniqid(); ?>" title="<?php echo esc_attr($data->placeholder); ?>" data-placeholder="<?php echo esc_attr($data->placeholder); ?>">
