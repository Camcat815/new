...
// 					$response->data = NULL;
		...
		final function _CheckWPPlugin( $purchase_key, &$error = "", &$responseObj = null ) {
			...
			if($manual_activation){
				$responseObj = (object) ['is_valid' => '1', 'expire_date' => '2026-01-01', 'support_end' => '2025-01-01', 'license_title' => 'Single License Manual Activation', 'license_key' => 'ManualXXXXXXXXXX', 'msg' => 'msg'];
