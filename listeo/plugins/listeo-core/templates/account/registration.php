                ...
                <div class="listeo-register-form-fields-container">
                    ...
                    ?>
                        <div class="account-type">
                            <div>
                                <input type="radio" name="user_role" id="freelancer-radio<?php echo $random; ?>" value="guest" class="account-type-radio" <?php if ($default_role == 'guest') { ?> checked <?php  } ?> />
                                <label for="freelancer-radio<?php echo $random; ?>"><i class="sl sl-icon-user"></i> <?php esc_html_e('Guest', 'listeo_core') ?></label>
                            </div>
                            ...
                            <?php else : ?>
                                <div>
                                    <input type="radio" name="user_role" id="employer-radio<?php echo $random + 1; ?>" value="owner" class="account-type-radio" <?php if ($default_role == 'owner') { ?> checked <?php  } ?> />
                                    <label for="employer-radio<?php echo $random + 1; ?>"><i class="sl sl-icon-briefcase"></i> <?php esc_html_e('Owner', 'listeo_core') ?></label>
                                </div>
                            <?php endif; ?>
                        </div>
