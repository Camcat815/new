	...
	class CartFlows_Pro_Licence {
		...
		public function license_popup_link( $links ) {
			...
			if ( 'Deactivated' == $this->activate_status ) {
				$links['license_key'] = '<a href="' . admin_url( 'admin.php?page=cartflows&settings=1&license=1' ) . '" class="cartflows-license-popup-open-button active" aria-label="' . esc_attr__( 'Settings', 'cartflows-pro' ) . '">' . esc_html__( 'Activate License', 'cartflows-pro' ) . '</a>';
			} else {
				$links['license_key'] = '<a href="' . admin_url( 'admin.php?page=cartflows&settings=1&license=1' ) . '" class="cartflows-license-popup-open-button inactive" aria-label="' . esc_attr__( 'Settings', 'cartflows-pro' ) . '">' . esc_html__( 'Deactivate License', 'cartflows-pro' ) . '</a>';
			}
