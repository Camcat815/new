...
?>
		...
		public function _content_install_settings()
		{
			...
			foreach ($custom_options as $option => $value) {
				...
				// 	}
				// }
				if (in_array($option, array('pp_body_font','listeo_side_social_icons', 'pp_footericons','listeo_listing_types', 'listeo_single_taxonomies_checkbox_list', 'listeo_listings_top_buttons_conf', 'listeo_home_slider'))) {
		...
		?>
			...
			<p>Congratulations! The theme has been activated and your website is (almost) ready.<br />
				<br />
				You can start make changes and modify any of the default content to suit your needs.
			</p>
