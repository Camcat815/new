                ...
                <div class="listing-item-content">
                    ...
                    if (!get_option('listeo_disable_reviews')) {
                        ...
                        if (isset($rating) && $rating > 0) : ?>
                            <div class="numerical-rating" data-rating="<?php $rating = str_replace(',', '.', $rating); $rating_value = esc_attr(round((float)$rating, 1));
                                                                        printf("%0.1f", $rating_value); ?>"></div>
                    <?php endif;
                    } ?>

                    <h3><?php the_title(); ?> <?php if (listeo_core_is_verified($post->ID)) : ?><i class="verified-icon"></i><?php endif; ?></h3>
