...
<body>
    <div class="text-container">
        ...
        <div class="left-side">
            ...
            if ($listing_logo) : ?>
                <img src="https://listeo.pro/wp-content/uploads/2018/11/cropped-stickylogo.webp" class="ticket-logo">
            <?php endif; ?>
        </div>
    ...
    <div id="invoice">
        ...
        <div class="col-md-9 ticket-content">
            ...
            <p id="details">
                ...
                <?php endif; ?>
                <?php if (isset($event_details['childers']) && !empty($event_details['childrens'])) : ?>
                    <strong><?php esc_html_e('Childrens', 'listeo_core'); ?>:</strong> <?php echo esc_html($event_details['childrens']); ?> <br>
                <?php endif; ?>
